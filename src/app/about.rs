...
const SOURCE_CODE_URL: &str = "https://github.com/assassin321/pure-clash";
/// 最新版本查询端点（GitHub Releases API）。
const RELEASES_API_URL: &str = "https://api.github.com/repos/assassin321/pure-clash/releases/latest";
